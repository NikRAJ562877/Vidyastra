...
const AdminAttendance = () => {
  ...
  const [classFilter, setClassFilter] = useState(mockClasses[0]);
  const [batchFilter, setBatchFilter] = useState(mockBatches[0]);
  ...
  const filteredStudents = useMemo(() => {
    return students.filter(
      (s) => s.class === classFilter && s.batch === batchFilter,
    );
