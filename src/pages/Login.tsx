    ...
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input value={email} onChange={e => setEmail(e.target.value)} placeholder="admin@academy.com" required />
            </div>
            <div className="space-y-2">
          ...
          <div className="mt-8 p-4 rounded-lg bg-muted text-xs space-y-1.5">
            ...
            <p><span className="text-muted-foreground">Admin:</span> admin@academy.com / admin123</p>
            <p><span className="text-muted-foreground">Teacher:</span> rajesh@academy.com / teacher123</p>
            <p><span className="text-muted-foreground">Student:</span> aarav@test.com / student123</p>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 gradient-hero items-center justify-center p-12">
        <div className="text-center text-primary-foreground max-w-md">
          ...
          <h2 className="text-3xl font-heading font-bold">Empowering Education</h2>
          <p className="mt-3 text-primary-foreground/70">Access your personalized dashboard, track progress, and achieve academic excellence.</p>
        </div>
      </div>
    </div>
  );
